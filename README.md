...
Paste a BNB Chain, Ethereum, Base, or Solana address. Runway pulls the current balance and the last 30 days of outflows, and shows you the actual day count — not a dashboard full of numbers you have to interpret yourself.
...
- Pulls 30 days of outflow history via BscScan, Etherscan/Basescan, or Solscan depending on the chain
...
- Ships with a live ETH Chain demo wallet preloaded — see a real result with zero clicks
